...
plt.plot(pos_x_list, pos_y_data[7], 'k-', zorder=1, lw=1,  color="orange", label="Top of the airfoil")
plt.plot(neg_x_list, neg_y_data[7], 'k-', zorder=1, lw=1,  color="blue", label="Bottom of airfoil")
